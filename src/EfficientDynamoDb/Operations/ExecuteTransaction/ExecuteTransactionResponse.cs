...
namespace EfficientDynamoDb.Operations.ExecuteTransaction
{
    ...
    public class ExecuteTransactionEntityResponse<TEntity> where TEntity : class
    {
        /// <summary>
        ...
        /// </summary>
        [DynamoDbProperty("Responses", typeof(ExecuteTransactionItemsResponsesConverter<>))]
        public IReadOnlyList<ExecuteTransactionItemResponse<TEntity>> Responses { get; set; } = null!;
    }

    public class ExecuteTransactionItemResponse<TEntity> where TEntity : class
    {
        [DynamoDbProperty("Item")]
        public TEntity? Item { get; set; } = null!;
    }

    internal sealed class ExecuteTransactionItemsResponsesConverter<TValue> : JsonIReadOnlyListDdbConverter<TValue>
    {
        public ExecuteTransactionItemsResponsesConverter(DynamoDbContextMetadata metadata) : base(CreateValueConverter(metadata))
        {
        }
