namespace EfficientDynamoDb.Operations.Shared
{
    public enum Select : byte
    {
        ...
        Count = 2,
        /// <summary>
        /// Returns only the attributes listed in <see cref="IterableRequest.ProjectionExpression"/>. This return value is equivalent to specifying <see cref="IterableRequest.ProjectionExpression"/> without specifying any value for <see cref="Select"/>.<br/><br/>
