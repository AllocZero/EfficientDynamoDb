...
namespace EfficientDynamoDb.Context.Operations.Query
{
    internal sealed class QueryEntityRequestBuilder<TEntity> : IQueryEntityRequestBuilder<TEntity> where TEntity : class 
    {
        ...
        public IQueryEntityRequestBuilder<TEntity, TProjection> WithProjectedAttributes<TProjection>() where TProjection : class =>
            new QueryEntityRequestBuilder<TEntity, TProjection>(_context, new ProjectedAttributesNode(typeof(TProjection), null, _node));

        public IQueryEntityRequestBuilder<TEntity, TProjection> WithProjectedAttributes<TProjection>(params Expression<Func<TProjection, object>>[] properties) where TProjection : class =>
