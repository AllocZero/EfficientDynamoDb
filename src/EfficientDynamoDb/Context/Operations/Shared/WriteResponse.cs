...
namespace EfficientDynamoDb.Context.Operations.Shared
{
    public class WriteResponse
    {
        ...
        /// <c>ConsumedCapacity</c> is only returned if the <see cref="WriteRequest.ReturnConsumedCapacity"/> parameter was specified.
        /// </summary>
        public FullConsumedCapacity? ConsumedCapacity { get; set; }
        
        /// <summary>
        /// Information about item collections, if any, that were affected by the operation.
        /// <c>ItemCollectionMetrics</c> is only returned if the <see cref="WriteRequest.ReturnItemCollectionMetrics"/> parameter was specified.
