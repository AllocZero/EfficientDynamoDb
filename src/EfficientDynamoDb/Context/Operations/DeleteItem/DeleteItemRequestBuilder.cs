...
{
    public readonly struct DeleteItemRequestBuilder<TEntity> where TEntity : class
    {
        ...
        public DeleteItemRequestBuilder<TEntity> WithCondition(FilterBase condition) =>
            new DeleteItemRequestBuilder<TEntity>(_context, new ConditionNode(condition, _node));

        public DeleteItemRequestBuilder<TEntity> WithCondition(Func<EntityFilter<TEntity>, FilterBase> conditionSetup)=>
            new DeleteItemRequestBuilder<TEntity>(_context, new ConditionNode(conditionSetup(Condition.ForEntity<TEntity>()), _node));

        public DeleteItemRequestBuilder<TEntity> WithPrimaryKey<TPk, TSk>(TPk pk, TSk sk) =>
            new DeleteItemRequestBuilder<TEntity>(_context, new PartitionAndSortKeyNode<TPk, TSk>(pk, sk, _node));

        public DeleteItemRequestBuilder<TEntity> WithPrimaryKey<TPk>(TPk pk) =>
            new DeleteItemRequestBuilder<TEntity>(_context, new PartitionKeyNode<TPk>(pk, _node));

        public DeleteItemRequestBuilder<TEntity> WithReturnValues(ReturnValues returnValues) =>
            new DeleteItemRequestBuilder<TEntity>(_context, new ReturnValuesNode(returnValues, _node));

        public DeleteItemRequestBuilder<TEntity> WithReturnConsumedCapacity(ReturnConsumedCapacity returnConsumedCapacity) =>
            new DeleteItemRequestBuilder<TEntity>(_context, new ReturnConsumedCapacityNode(returnConsumedCapacity, _node));

        public DeleteItemRequestBuilder<TEntity> WithReturnCollectionMetrics(ReturnItemCollectionMetrics returnItemCollectionMetrics) =>
