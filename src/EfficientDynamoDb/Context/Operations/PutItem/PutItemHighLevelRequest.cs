...
{
    internal class PutItemHighLevelRequest : IItemType, IItem, IReturnValues, IReturnConsumedCapacity, IReturnItemCollectionMetrics, IUpdateCondition
    {
        ...
        public FilterBase? UpdateCondition { get; set; }
    }
}