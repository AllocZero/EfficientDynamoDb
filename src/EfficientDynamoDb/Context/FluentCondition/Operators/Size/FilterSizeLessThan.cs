...
{
    internal sealed class FilterSizeLessThan<TEntity, TProperty> : FilterBase<TEntity>
    {
        private TProperty _value;

        public FilterSizeLessThan(Expression expression, TProperty value) : base(expression) => _value = value;
