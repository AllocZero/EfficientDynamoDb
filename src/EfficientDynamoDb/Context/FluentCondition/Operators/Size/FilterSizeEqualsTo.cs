...
{
    internal sealed class FilterSizeEqualsTo<TEntity, TProperty> : FilterBase<TEntity>
    {
        private TProperty _value;

        public FilterSizeEqualsTo(Expression expression, TProperty value) : base(expression) => _value = value;
