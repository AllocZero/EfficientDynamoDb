...
{
    internal sealed class FilterSizeGreaterThanOrEqualsTo<TEntity, TProperty> : FilterBase<TEntity>
    {
        private TProperty _value;

        public FilterSizeGreaterThanOrEqualsTo(Expression expression, TProperty value) : base(expression) => _value = value;
