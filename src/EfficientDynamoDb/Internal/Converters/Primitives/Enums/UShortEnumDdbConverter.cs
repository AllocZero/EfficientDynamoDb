...
namespace EfficientDynamoDb.Internal.Converters.Primitives.Enums
{
    ...
    {
        public UShortEnumDdbConverter() : base(true)
        {
        }
        ...
        {
            attributeValue = new AttributeValue(new NumberAttributeValue(Unsafe.As<TEnum, ushort>(ref value).ToString()));
            return true;
        }

        public override AttributeValue Write(ref TEnum value) => new AttributeValue(new NumberAttributeValue(Unsafe.As<TEnum, ushort>(ref value).ToString()));
        ...
        public void WritePropertyName(in DdbWriter writer, ref TEnum value) => writer.JsonWriter.WritePropertyName(Unsafe.As<TEnum, ushort>(ref value));
        
        public void WriteStringValue(in DdbWriter writer, ref TEnum value) => writer.JsonWriter.WriteStringValue(Unsafe.As<TEnum, ushort>(ref value));
