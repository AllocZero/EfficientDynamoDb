...
namespace EfficientDynamoDb.Internal.Converters.Primitives.Numbers
{
    internal sealed class DecimalDdbConverter : NumberDdbConverter<decimal>, IDictionaryKeyConverter<decimal>, ISetValueConverter<decimal>
    {
        ...
        public void WritePropertyName(Utf8JsonWriter writer, ref decimal value) => writer.WritePropertyName(value);
        
        public void WriteStringValue(Utf8JsonWriter writer, ref decimal value) => writer.WriteStringValue(value);
