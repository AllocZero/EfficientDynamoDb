...
namespace EfficientDynamoDb.Internal.Converters.Primitives.Numbers
{
    internal sealed class ShortDdbConverter : NumberDdbConverter<short>, IDictionaryKeyConverter<short>, ISetValueConverter<short>
    {
        ...
        public void WritePropertyName(Utf8JsonWriter writer, ref short value) => writer.WritePropertyName(value);
        
        public void WriteStringValue(Utf8JsonWriter writer, ref short value) => writer.WriteStringValue(value);
