...
namespace EfficientDynamoDb.Api.DescribeTable.Models
{
    public class TableDescription
    {
        ...
        public IReadOnlyCollection<AttributeDefinition> AttributeDefinitions { get; set; } = Array.Empty<AttributeDefinition>();
        
        public BillingModeSummary? BillingModeSummary { get; set; }
        
        public DateTime CreationDateTime { get; set; }

        public IReadOnlyCollection<GlobalSecondaryIndexDescription> GlobalSecondaryIndexes { get; set; } = Array.Empty<GlobalSecondaryIndexDescription>();
        
        public string? GlobalTableVersion { get; set; }
        
        public long ItemCount { get; set; }

        public IReadOnlyCollection<KeySchemaElement> KeySchema { get; set; } = Array.Empty<KeySchemaElement>();
        
        public string? LatestStreamArn { get; set; }
        
        public string? LatestStreamLabel { get; set; }

        public IReadOnlyCollection<LocalSecondaryIndexDescription> LocalSecondaryIndexes { get; set; } = Array.Empty<LocalSecondaryIndexDescription>();
        
        public ProvisionedThroughputDescription? ProvisionedThroughput { get; set; }

        public IReadOnlyCollection<ReplicaDescription> Replicas { get; set; } = Array.Empty<ReplicaDescription>();
