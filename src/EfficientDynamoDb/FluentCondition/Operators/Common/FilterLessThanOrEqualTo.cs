...
{
    internal sealed class FilterLessThanOrEqualTo<TEntity, TProperty> : FilterBase<TEntity>
    {
        private readonly bool _useSize;
        private TProperty _value;

        public FilterLessThanOrEqualTo(Expression expression, bool useSize, TProperty value) : base(expression)
        {
            _useSize = useSize;
            _value = value;
        }
    ...
    internal sealed class FilterLessThanOrEqualTo<TEntity> : FilterBase<TEntity>
    {
        private readonly bool _useSize;
        private readonly Expression _valueExpression;
        private readonly bool _useValueSize;

        public FilterLessThanOrEqualTo(Expression expression, bool useSize, Expression valueExpression, bool useValueSize) : base(expression)
        {
            _useSize = useSize;
