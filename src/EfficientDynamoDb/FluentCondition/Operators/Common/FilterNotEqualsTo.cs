...
namespace EfficientDynamoDb.FluentCondition.Operators.Common
{
    internal sealed class FilterNotEqualsTo<TEntity, TProperty> : FilterBase<TEntity>
    {
        ...
        public FilterNotEqualsTo(Expression expression, bool useSize, TProperty value) : base(expression)
        {
            _useSize = useSize;
            _value = value;
        }
    ...
    internal sealed class FilterNotEqualsTo<TEntity> : FilterBase<TEntity>
    {
        ...
        public FilterNotEqualsTo(Expression expression, bool useSize, Expression valueExpression, bool useValueSize) : base(expression)
        {
            _useSize = useSize;
